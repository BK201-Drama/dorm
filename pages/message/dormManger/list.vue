	...
	<view>
		<view class="uni-header">
			<view class="uni-group hide-on-phone">
				<view class="uni-title">楼管信息管理</view>
		...
		<view class="uni-container">
			<unicloud-db ref="udb" @load="onqueryload" collection="dormManger,uni-id-roles" :options="options"
				:where="where" field="_id,dormMangerID,name,gender,role{role_id,role_name},mobile,dormBuildingNo"
				page-data="replace" :orderby="orderby" :getcount="true" :page-size="options.pageSize"
				:page-current="options.pageCurrent" v-slot:default="{data,pagination,loading,error}">
				<uni-table :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
					@selection-change="selectionChange">
					<uni-tr>
						<uni-th align="center">楼管编号</uni-th>
						<uni-th align="center">名称</uni-th>
						<uni-th align="center">性别</uni-th>
						<uni-th align="center">角色</uni-th>
						<uni-th align="center">手机</uni-th>
						<uni-th align="center">宿舍楼号</uni-th>					
						<uni-th align="center">操作</uni-th>		
					</uni-tr>
					<uni-tr v-for="(item,index) in data" :key="index">
						<uni-td align="center">{{item.dormMangerID}}</uni-td>
...
<script>
	...
	const dbSearchFields = ["dormMangerID","name","dormBuildingNo"] // 支持模糊搜索的字段列表
	// 分页配置
	const pageSize = 20
	const pageCurrent = 1
